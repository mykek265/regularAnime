...
s2dpl::Triangle::Triangle(b2World& sworld, sf::RenderWindow& swindow, sf::Vector2f spos, sf::Vector2f v3[], float dencity, float elasticity, float friction, int type, uint16 im, uint16 icol)
{
	world = &sworld;
	window = &swindow;
	pos = spos;
...
s2dpl::Triangle::Triangle(b2World& sworld, sf::RenderWindow& swindow, sf::Vector2f spos, sf::Vector2f v0, sf::Vector2f v1, sf::Vector2f v2, float dencity, float elasticity, float friction, int type, uint16 im, uint16 icol)
{
	sf::Vector2f v3[3] = { v0, v1, v2 };
	world = &sworld;
	window = &swindow;
	pos = spos;
	angle = 0.f;
