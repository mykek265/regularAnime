...
s2dpl::Circle::Circle(b2World& sworld, sf::RenderWindow& swindow, sf::Vector2f spos, float r, float density, float friction, float elasticity, int type, uint16 im, uint16 icol)
{
	world = &sworld;
	window = &swindow;
	pos = spos;
